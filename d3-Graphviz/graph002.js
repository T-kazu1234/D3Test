...
//下り通信**************************************************************************************
     ['digraph{',
        ...
        'S31[label="光モジュラージャック",shape=plaintext]',
        'S32[label="光モデム",shape=plaintext]',
        'S33[label="ルーター",shape=plaintext]',
        'S34[label="MacBook",shape=plaintext]',
        'S35[label="iPhone",shape=plaintext]',
        'S31->S32 [dir = forward,label="受信"]',
        'S32->S33 [dir = forward,label="受信"]',
        'S33->S34 [dir = forward,label="無線\n(WiFi)",style=dotted]',//下り
        'S33->S35 [dir = forward,label="無線\n(WiFi)",style=dotted]',//下り
        '}',
        'subgraph cluster_2 {',
        '     node [style=filled];',
        'label = "家の外"',
...
//上り通信**************************************************************************************
     ['digraph{',
        ...
        'S33->S34 [dir = back,label="無線\n(WiFi)",color = "red",style=dotted]',//下り
        'S33->S35 [dir = back,label="無線\n(WiFi)",color = "red",style=dotted]',//下り
        '}',
        'subgraph cluster_2 {',
        '     node [style=filled];',
        'label = "家の外"',
