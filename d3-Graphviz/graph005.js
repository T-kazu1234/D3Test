...
//下り通信**************************************************************************************
     ['digraph{',
        ...
        'subgraph cluster_1 {',
            'label = "enchant"',
                'Node_0002[label="EventTarget",shape=plaintext]',
                'Node_0003[label="Game",shape=plaintext]',
                'Node_0004[label="Node",shape=plaintext]',
                'Node_0005[label="Entity",shape=plaintext]',
                'Node_0006[label="Sprite",shape=plaintext]',
                'Node_0007[label="Group",shape=plaintext]',
                'Node_0008[label="Scene",shape=plaintext]',
            '}',
        'subgraph cluster_2 {',
           'label = "enchant.nineleap"',
                'Node_0009[label="SprashScene",shape=plaintext]',
                'Node_0010[label="Game",shape=plaintext]',
/*
                'Node_0011[label="Node",shape=plaintext]',
                'Node_0012[label="Entity",shape=plaintext]',
                'Node_0013[label="Sprite",shape=plaintext]',
                'Node_0014[label="Group",shape=plaintext]',
                'Node_0015[label="Scene",shape=plaintext]',
*/
            '}',

        'Node_0002->Node_0004->Node_0005->Node_0006 [dir = back,label="",color = "red"]',
        'Node_0002->Node_0003->Node_0010 [dir = back,label="",color = "red"]',
        'Node_0004->Node_0007->Node_0008->Node_0009 [dir = back,label="",color = "red"]',
