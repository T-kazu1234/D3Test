...
function render() {
    ...
    graphviz
    	...
    	.addImage("https://scrapbox.io/api/pages/Tanakake-memo/アライさん/icon", "400px", "300px")
...
//      '    subgraph cluster_1 {',
        '       node [style=filled]',
        '    b0 [labelloc=b,fontsize = 18,image="https://scrapbox.io/api/pages/Tanakake-memo/アライさん/icon", label=" ScrapBox", shape=plaintext,href="https://scrapbox.io/pages/Tanakake-memo/アライさん/"]',
        '    b0 -> b1 -> b2 -> b3 -> b0',
        '    label = "process #2"',
        '    color=blue',
//      '    }',
        '    start -> a0',
        '    start -> b0',
        ' a1 -> b3 [fontname = ダミー,label = "エッジラベル", href="http://ja.wikipedia.org/wiki/師弟" ]',
        ' b2 -> a3',
        ' a3 -> a0',
        ' a3 -> end',
        ' b3 -> end',
